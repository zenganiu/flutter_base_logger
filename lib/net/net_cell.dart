...
import 'package:flutter_base_logger/page/json_view_page.dart';
...
class _NetCellState extends State<NetCell> {
  ...
  Widget build(BuildContext context) {
    ...
    return ExpansionTile(
      ...
      subtitle: Text(item.api.toString(), style: const TextStyle(fontSize: 14, color: Colors.black)),
...
class _CopyTextAndButton extends StatelessWidget {
  ...
  const _CopyTextAndButton({required this.content, required this.title, this.onTapCopy, this.onTapButton});
...
class _CopyText extends StatelessWidget {
  ...
  const _CopyText({required this.content, required this.title, this.onTapCopy});

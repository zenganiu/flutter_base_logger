...
import 'package:flutter_base_logger/json_view/json_view.dart';
...
class _DJsonViewPageState extends State<DJsonViewPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(child: _buildJsonView()),
    );
  }
  ...
  Widget _buildJsonView() {
    final child = canConvertToObject(widget.jsonString)
        ...
        : SingleChildScrollView(
            child: Text(widget.jsonString, style: const TextStyle(fontSize: 14, color: Colors.black)),
          );

...
import 'package:flutter_base_logger/page/logger_list_page.dart';
...
class DOverlayDebugView extends StatefulWidget {
  ...
  const DOverlayDebugView({super.key, this.offset = const Offset(0, 300), this.height = 50, this.overlayEntry});
